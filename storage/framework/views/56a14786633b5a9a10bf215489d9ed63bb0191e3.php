...
<body>
  ...
  <main id="main">
    ...
    <section id="about-1" class="about">
      <div id="about-1" class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center align-items-stretch"  >
            <div class="content">
                ...
                <a href="<?php echo e(url('/rudev')); ?>" class="book-a-table-btn scrollto">ICT-Rudev</a>
              </div>
          </div>

          <div class="col-lg-7 d-flex" style='background-image: url("assets/img/rudev2.png"); object-fit: contain;'>
    ...
    <section id="about-2" class="about">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-7" style='background-image: url("assets/img/summit2.png");'>
            </div>
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-stretch">
              ...
              <div class="content">
                ...
                <a href="<?php echo e(url('summit')); ?>" class="book-a-table-btn scrollto">ICT-Summit</a>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\rudev-app\resources\views/portal.blade.php ENDPATH**/ ?>