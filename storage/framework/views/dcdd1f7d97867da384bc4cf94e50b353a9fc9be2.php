...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/RUDEVIEEE.png" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">CALL FOR PAPER</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#keynote_speakers">KEYNOTE SPEAKERS</a>
                </li>
                <li class="nav-item">
    ...
    <div id="keynote_speakers" class="slider">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>KEYNOTE</h2>
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="images/nadim2.jfif" alt="alternative">
                                        <div class="card-body">
                                            <div class="testimonial-text">T</div>
                                            <div class="testimonial-author">
                                                Nadiem Makarim -Ministry of Education and Culture</div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="images/Johnny_G.jpg" alt="alternative">
                                        <div class="card-body">
                                            <div class="testimonial-text"></div>
                                            <div class="testimonial-author">Johnny G. Plate - THE MINISTER OF COMMUNICATION AND INFORMATICS OF THE REPUBLIC OF INDONESIA</div>
                                        </div>
                                    </div>        
                                </div> <!-- end of swiper-slide -->
                                <!-- end of slide -->
                ...
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>With the theme “ICT Development for Rural Development: Digital Economy and 
                            ...
                            particularly in digital economy and human resource sectors. This conference aims to 
                            gather researchers, academicians, practitioners, regulators to exchange ideas, innovations,
                            experiences, research papers, and development programs regarding this. We call for plenary
                            speakers from around the world to present their innovative ideas and share the inspiration
                            with our attendees at this global platform under following themes.</p>
                            <ul>
                                <li>Innovative Educational Practices (each tab link to the call for papers)</li>
                                <li>Assessment Reliability and Validity</li>
                                <li>Curriculum that Works</li>
                                <li>Effective Technology in the Classroom</li>
                                <li>Working with Diverse Populations</li>
                                <li>Learning Science</li>
                            </ul>
                            <p style="font-size:130%;">What we are looking for?</p>
                            <ul>
                                <li>Innovative and exciting industry-led content and research</li>
                                <li>Content including: industry trends & research, new technology, new policies & related case studies</li>
                                <li>Innovative and immersive presentation ideas and concepts</li>
                                <li>Expertise and knowledge in your field</li>
                                <li>Presence and passion</li>
                            </ul>
                            <p style="font-size:130%;">Format of your speech</p>
                            <ul>
                                <li>Each presentation is at least 30 minutes.</li>
                                <li>Presentations can be done in the format of a plenary speech. Presentations are conducted in English. No translation is provided.</li>
                                <li>The session could be a lecture format, presentation of research results, demonstration, train-the trainer workshop, or presentation of a case study.</li>
                                <li>The audience will be a combination of industry professionals, academics and students and presenters should relate their topic to each groups.</li>
                            </ul>	
                            <p style="font-size:130%;">Submission Guidelines</p>
                            <p>Send your proposal or inquiries to <a href=""> conference@kominfo.go.id</a></p>
                            <p>Proposals should include:</p>
                            <ul>
                                <li>Suggested presentation title</li>
                                <li>Short description of presentation (up to 300 words)</li>
                                <li>Main topics covered</li>
                                <li>Main benefits for the participants</li>
                                <li>Presenter short bio (50 words) or CV</li>
                            </ul>	
    ...
    <div id="services" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title"><h1>CALL FOR PAPER<h1></div>
                    <div class="section-title">Paper submission deadline: 1st June 2020</div>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="media">
                        <div class="media-body">
                            <p>Paper Format - Papers submitted for IC-ICTRuDev 2020 should be up to 6 pages of text including figures and possible references. The authors are responsible to ensure that the submitted papers are in the correct styles, fonts, etc. The submitted papers must be in the PDF format.</p>
                            <br>
                            <p>Template - The Style Manual and Conference Paper templates in various formats are available <a href="https://www.ieee.org/conferences/publishing/templates.html" target="_blank">here</a>.</p>
                            <br>
                            <p>Use PDF eXpress Format - Before submitting your papers, please use IEEE PDF eXpress to comply with IEEE requirements: (<a href="https://www.pdf-express.org/"  target="_blank">PDF eXpress</a>) </p>
                            <p>Conference ID: 50538</p>
                            <p>Below, we provide information to create your PDF eXpress documents.</p>
                            <br>
                            <p>Step by Step Creating Your PDF eXpress Account:</p>
                            <ul>
                                <li>Go to IEEE - PDF eXpress site: <a href="https://www.pdf-express.org/" target="_blank">PDF eXpress</a></li>
                                <li>Select the New Users - <a href="https://www.pdf-express.org/contributor.asp?Email=&SiteID=" target="_blank">Click Here link</a>.</li>
                                <li>Enter the following:</li>
                                    <ol>
                                        <li>50538 for the Conference ID</li>
                            ...
                            <p>Paper Submission Procedure - Submit your papers in pdf format through EDAS system (https://edas.info/N24660)</p>
                            <p>Non-presented Paper Policy IEEE reserves the right to exclude a paper from distribution after the conference, including IEEE Xplore Digital Library, if the paper is not presented by the author at the conference.</p>
                        </div>
                    </div>
		...
		<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>IMPORTANT DATE & PROGRAMME</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="button-group filters-button-group">
                        <a class="button is-checked" data-filter=".IM1"><span>IMPORTANT DATE</span></a>
                        <a class="button" data-filter=".DAY1"><span>PROGRAMME DAY 1</span></a>
                        <a class="button" data-filter=".DAY2"><span>PROGRAMME DAY 2</span></a>
            ...
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="image-container">
                        <img class="img-fluid" src="images/zoomok.jpg" alt="alternative">
...
</html><?php /**PATH C:\xampp\htdocs\rudev-app\resources\views/web.blade.php ENDPATH**/ ?>