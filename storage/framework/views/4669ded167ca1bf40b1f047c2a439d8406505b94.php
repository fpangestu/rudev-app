                    ...
                    <div class="feature-box m-0px-b">
                        ...
                        <form action="/" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="institution" value="<?php echo e(old('institution')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="occupation">Occupation</label>
                                <input class="form-control" type="text" name="occupation" value="<?php echo e(old('occupation')); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="abstract" rows="7" value="<?php echo e(old('title')); ?>"></textarea>
                            </div>
